...
import { FaHome, FaBullhorn, FaCalendarAlt, FaBell, FaSignOutAlt, FaBars, FaTimes, FaUserPlus } from 'react-icons/fa';
...
const AdminLayout: React.FC<AdminLayoutProps> = ({ children, title }) => {
  ...
  const menuItems = [
    ...
    { href: '/admin/preliminary-applications', label: '예비 신청 관리', icon: FaUserPlus },
  ];
